...
acks=all
EOF
  filename            = "${path.module}/healthcheck/consumer-primary.properties"
...
acks=all
EOF
  filename            = "${path.module}/healthcheck/consumer-secondary.properties"
  file_permission    = "0777"
}
...
EOF
  filename            = "${path.module}/healthcheck/producer-primary.properties"
  file_permission    = "0777"
}
...
acks=all
EOF
  filename            = "${path.module}/healthcheck/producer-secondary.properties"
  file_permission    = "0777"
}